...
- [x] Einheit 2 (Conditionals & Abstraction)  
  - [x] Labs & optionale Projekte in aktueller Struktur.  
  - [x] Legacy-/`old`-Material bleibt unverändert; keine Lokalisierung oder Archivierung geplant.  
  - [x] Hinweis: Beide Varianten von `assessment-data2` (unter `cur/programming/2-complexity/...` und `cur/programming/summaries/...`) bleiben bestehen und werden bei Pflege separat berücksichtigt.  
- [x] Einheit 3 (Data Structures)  
  ...
  - [x] Assessments & Legacy (`old/`, `unused-*`) – bleibt unverändert; Legacy-Versionen bewusst nicht lokalisiert.  
- [x] Einheit 4 (Internet & Privacy)  
...
- [ ] Einheit 5 (Algorithms & Simulations)  
  ...
  - [x] Labor 3 (Turning Data into Information)  
    - [x] Seiten 1–6 – abgeschlossen (2025-10-31).  
  - [x] Labor 4 (Unsolvable & Undecidable Problems)  
    - [x] Seiten 1–2 – abgeschlossen (2025-10-31).  
  - [x] Labor 5 (Computing in War)  
    - [x] Seiten 1–3 – abgeschlossen (2025-10-31).  
  - [x] Labor 6 (Tic-Tac-Toe with Computer Player)  
    - [x] Seiten 1–4 – abgeschlossen (2025-10-31).  
  - [x] Optionales Labor (Other Programming Languages)  
    - [x] Seiten 1–3 – abgeschlossen (2025-10-31).  
  - [x] Optionales Thema „Mutation“  
    - [x] Seiten 1–3 – abgeschlossen (2025-10-31).   
- [x] Einheit 6 (How Computers Work) – komplette Übersetzung abgeschlossen (2025-11-01).  
  - [x] Labor 1 (Abstraction)  
...
- [x] Einheit 7 (Recursion) – komplette Übersetzung abgeschlossen (2025-11-01).  
  - [x] Labor 1 (Trees)  
...
- [x] Einheit 8 (Recursive Reporters) – komplette Übersetzung abgeschlossen (2025-11-01).  
  - [x] Labor 1 (Recursive Reporters)  
    - [x] Seiten 1–2 („Counting Trees“, „Writing Recursive Reporters“) – neu übersetzt (2025-11-01).  
  - [x] Labor 2 (Base Conversion)  
    - [x] Seiten 1–2 („Binary Conversion“, „Base Conversion“) – neu übersetzt (2025-11-01).  
  - [x] Labor 3 (Subsets)  
    - [x] Seiten 1–2 („Counting Ice Cream Bowls“, „Listing the Subsets“) – neu übersetzt (2025-11-01).  
  - [x] Labor 4 (Building Higher Order Functions)  
    - [x] Seiten 1–3 („Walking Down a List“, „Generalizing the Map Pattern“, „Even Numbers and Keep“) – neu übersetzt (2025-11-01).  
- [x] Lehrkräfte-/Kursstartseiten (z. B. `course/*.html`, `index*.html`) lokalisieren – Kurs- und Startseiten, inklusive `index*.html`, haben nun `.de`-Versionen (Stand 2025-11-01).  
- [x] Snap<em>!</em>-Spickzettel & Snap<em>!</em>-Crashkurs lokalisiert (2025-11-01).  
- [x] Lehrer-Ressourcenseite `/cur/teaching-guide/resources/tg-resources.de.html` ergänzt (2025-11-01).  
- [x] `docs/best_practices.de.html` angelegt (HTML-Codierleitfaden auf Deutsch, 2025-11-01).  
- [x] `docs/general-snippets.de.html` und `docs/why-this-why-heres.de.html` hinzugefügt (2025-11-01).  
- [x] `docs/translating.de.md` hinzugefügt (Übersetzungsguide, 2025-11-01).  
- [x] `docs/translating.de.md` hinzugefügt (Übersetzungsguide, 2025-11-01).  
